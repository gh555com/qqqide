...
function effectiveHost() {
  ...
  if (HOST.includes('203.0.113.11')) {
    return 'q@203.0.113.10';  // SCP to CN first
  }
  return HOST;
}

function isUSDeploy() {
  return HOST.includes('203.0.113.11');
}
...
if (isUSDeploy()) {
  ...
  console.log('[deploy] ✓ CN deploy complete. US sync in background, check: ssh q@203.0.113.10 tail /tmp/_deploy_sync.log');
}
