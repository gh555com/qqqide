...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { GATEWAY_URL, VISION_URL, BILLING_FLUSH_URL, SYSTEM_PROMPT, TRIVIAL_REGEX, CHAT_REGEX, TIER_FLASH, TIER_PRO };
}
...
window.loadQqqRules = async function () {
    try {
        if (typeof bridge !== 'undefined' && bridge.app && bridge.app.root) {
        ...
        console.log('[rules] no global.txt or read error');
    }
};
...
window.loadProjectRules = async function (projectRoot) {
    try {
        ...
        console.log('[rules] no project.txt or read error');
    }
};
